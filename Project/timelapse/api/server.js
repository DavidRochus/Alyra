...
addProposal2 = async (_data) => {
  accountAddress = "0x3ad53d26D15A658A84Fe8cA9FFc8aA3a7240C1a0";
  accountPrivateKey = Buffer.from(
    "5e452d592d300152bd6499853ca5d814265f8627cb44a8658bb3fb592acf5275",
    "hex"
  );
  ...
  const data = timelapseInstance.methods
    .addProposal(
      _data.minScoring,
      _data.capital,
      _data.interest,
  ...
  const txObject = {
    ...
    from: accountAddress,
    to: timelapseNetwork.address,
    data: data,
  };
  console.log("txObject", txObject);

  var TIMELAPSE_BLOCKCHAIN = ethereumjs_common.forCustomChain(
    "ropsten",
    { networkId: 1000, chainId: 1000, name: "geth" },
    "muirGlacier"
  );
  //var transaction = new Transaction (transaction_data, { "common": common });

  //var tx = new Tx(txObject, { chain: "ropsten" });
  var tx = new Tx(txObject, { common: TIMELAPSE_BLOCKCHAIN });
